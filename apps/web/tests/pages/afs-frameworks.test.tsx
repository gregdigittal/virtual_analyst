...
import AfsFrameworksPage from "@/app/(app)/afs/frameworks/page";
...
describe("AfsFrameworksPage", () => {
  ...
  it("renders without crashing", async () => {
    renderPage();
    await waitFor(() => {
      expect(screen.getByRole("heading", { name: /Create Custom Framework/i })).toBeInTheDocument();
    });
  });
