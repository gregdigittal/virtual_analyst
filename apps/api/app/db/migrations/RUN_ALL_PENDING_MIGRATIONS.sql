-- =============================================================================
-- Virtual Analyst — Pending migrations (0008 through 0046)
...
-- ############################################################################
-- 0032_budget_approval_workflow.sql
-- ############################################################################
...
-- ############################################################################
-- 0035_board_pack_scheduling.sql
-- ############################################################################
...
-- ############################################################################
-- 0037_marketplace_templates.sql
-- ############################################################################
...
create policy llm_usage_log_select on llm_usage_log for select using (tenant_id = current_tenant_id());
create policy llm_usage_log_insert on llm_usage_log for insert with check (tenant_id = current_tenant_id());
